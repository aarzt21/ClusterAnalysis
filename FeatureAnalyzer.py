...
class FeatureAnalyzer:
    ...
    def _perm_feature_analysis(self, cluster) -> None:
        data = np.hstack([self.X, self.y.reshape((len(self.y),1))])
    ...
    def permutation_feature_analysis(self) -> None:
        ...
        sns.set_theme()
        for cluster in np.unique(self.y):
            self._perm_feature_analysis(cluster=cluster)
...
if __name__ == "__main__":
    ...
    feat_analyzer.permutation_feature_analysis()
